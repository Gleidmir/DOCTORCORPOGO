...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://doctorcorpogo.netlify.app/og_image.png?v=6" },
      { property: "og:image:secure_url", content: "https://doctorcorpogo.netlify.app/og_image.png?v=6" },
      ...
      { name: "twitter:image", content: "https://doctorcorpogo.netlify.app/og_image.png?v=6" },
